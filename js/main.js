...
function tableClassify(value1, value2, index, location) {
    return `
        <tr class="${location}">
            <td rowspan="${index}" class="text-wrap text-break" style="max-width: 200px">${value1}</td>
            <td >${value2}</td>
            <td>
